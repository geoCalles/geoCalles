...
public class PanelControllerTest {
  ...
  /*Test Geovany*/
  @Test
  public void testGetOnePanel() throws Exception {
    ResponseEntity<Panel> response = template.getForEntity("/api/panels/1234567890123456/hourly", 
    		Panel.class);
    Assert.assertEquals(200,response.getStatusCode().value());
  }
  
  @Test
  public void testWriteHourlyElectricity() throws Exception {
	  HttpEntity<Object> hourlyElectricity = getHttpEntity(
		        "{\"panel_id\": \"3\", \"generatedElectricity\": \"125\"," 
		            + " \"readingAt\": \"2018-05-25T10:17\"}");
